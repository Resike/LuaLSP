...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-arg)
---
---@type table
arg = {}
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-collectgarbage)
---
---@param opt? cgopt
---@param arg? integer
---@return any
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-dofile)
---
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-_G)
---
---@class _G
_G = {}
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-getfenv)
---
---@param f? function
---@return table
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-load>5.2)
---
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-loadfile)
---
---@param filename? string
---@param mode?     loadmode
---@param env?      table
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-loadstring)
---
---@param text       string
---@param chunkname? string
---@return function
...
---Creates a module.
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-module)
---
---@param name string
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-paris)
---
---@param t table
...
---
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-setfenv)
---
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-warn)
---
...
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-xpcall>5.1)
---
---@param f     function
---@param msgh  function
---@param arg1? any
...
---```
---
---[View documents](http://www.lua.org/manual/5.2/manual.html#pdf-unpack)
---
---@param list table
---@param i?   integer
---@param j?   integer
