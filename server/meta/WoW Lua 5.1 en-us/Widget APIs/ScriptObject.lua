...
--- @param scriptType string @ A script type
--- @param handler func @ A function to become the widget's handler for the script type
...
--- @param scriptType string @ Name of the script whose handler should be hooked
--- @param handler func @ A function to be called whenever the script handler is run
