...
function GetItemGem(name_or_itemlink, index) end
...
function IsItemInRange(itemName_or_itemLink, unit) end
...
function UnitIsGroupLeader(unit_or_PlayerName) end
...
function UnitSpellHaste(unit_or_name) end
