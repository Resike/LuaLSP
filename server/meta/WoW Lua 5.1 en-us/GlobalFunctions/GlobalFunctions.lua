...
---@return number friendID, string accountName, boolean isMutual
...
function ChannelToggleAnnouncements(channelName, name) end
...
function CollapseQuestHeader(questID) end
...
function CombatLog_Object_IsA(flag1, flag2) end
...
function DeleteMacro(index_or_macroname) end
...
function DisableAddOn(index_or_name, character) end
...
function DoEmote(token, target) end
...
function EditMacro(index_or_macroName, name, icon, body) end
...
function EnableAddOn(index_or_name, character) end
...
function EquipItemByName(itemId_or_itemName_or_itemLink, slot) end
...
function GetAchievementInfo(achievementID_or_categoryID, index) end
...
function GetActiveArtifactByRace(raceIndex, artifactIndex) end
...
function GetAddOnCPUUsage(index_or_name) end
...
function GetAddOnDependencies(index_or_name) end
...
function GetAddOnEnableState(character, addonIndex_or_AddOnName) end
...
function GetAddOnInfo(index_or_name) end
...
function GetAvailableLocales(ignoreLocalRestrictions) end
...
function GetBarberShopStyleInfo(catId) end
...
function GetBinding(index, mode) end
...
function GetChannelDisplayInfo(i) end
...
---@return number id, string name, boolean disabled, number ...
...
function GetChannelName(id_or_name) end
...
function GetChatTypeIndex(typeCode) end
...
function GetDetailedItemLevelInfo(itemID_or_itemString_or_itemName_or_itemLink) end
...
function GetGameMessageInfo() end
...
function GetGuildApplicantInfo(selectionID) end
...
function GetInventoryItemBroken(unit, slotId) end
...
function GetInventoryItemCooldown(unit, slotId) end
...
function GetInventoryItemCount(unit, slotId) end
...
function GetInventoryItemQuality(unitId, slotId) end
...
function GetInviteConfirmationInfo(invite) end
...
function GetItemCount(itemID_or_itemName_or_itemLink, includeBank, includeCharges) end
...
function GetItemFamily(itemId_or_itemName_or_itemLink) end
...
function GetItemInfoInstant(itemID_or_itemString_or_itemName_or_itemLink) end
...
function GetItemSpecInfo(itemLink_or_itemID_or_itemName, specTable) end
...
function GetItemSpell(itemID_or_itemString_or_itemName_or_itemLink) end
...
function GetLFGDungeonRewardCapBarInfo(VALOR_TIER1_LFG_ID) end
...
function GetMacroBody(macroIndex_or_name) end
...
function GetMacroInfo(name_or_macroSlot) end
...
function GetMacroSpell(slot_or_macroName) end
...
function GetQuestLogChoiceInfo(itemNum) end
...
function GetQuestLogLeaderBoard(i, questIndex) end
...
---@return string questDescription, string questObjectives
...
function GetSpellAutocast(spellName_or_spellId, bookType) end
...
function GetSpellBookItemTexture(spellName_or_index, bookType) end

---Returns information about the charges of a charge-accumulating player ability.
---@param spellId_or_spellName unknown
---@return number currentCharges, number maxCharges, number cooldownStart, number cooldownDuration, number chargeModRate
---[View Documents](https://wow.gamepedia.com/API_GetSpellCharges)
function GetSpellCharges(spellId_or_spellName) end
...
function GetSpellCooldown(spellName_or_spellID_or_slotID, bookType) end
...
function GetSpellInfo(spellId_or_spellName, spellRank) end
...
function GetSpellLossOfControlCooldown(spellSlot, bookType_or_spellName_or_spellID) end
...
function GetSpellPowerCost(spellName_or_spellID) end
...
function GetSpellTexture(spellId_or_spellName) end
...
function GetThreatStatusColor(statusIndex) end
...
function GetTotemInfo(index) end
...
function GetTradePlayerItemLink(i) end
...
function GetTrainerServiceIcon(id) end
...
function GetTrainerServiceInfo(id) end
...
function GetUnitPowerBarInfoByID() end
...
function GetUnitPowerBarStringsByID() end
...
function GetUnitPowerBarTextureInfoByID() end
...
function GiveMasterLoot(li, ci) end
...
function GuildRosterSetOfficerNote(index, Text) end
...
function GuildRosterSetPublicNote(index, Text) end
...
---@return boolean hasUI, boolean isHunterPet
...
function IsAddOnLoadOnDemand(index_or_name) end
...
function IsAddOnLoaded(index_or_name) end
...
function IsConsumableItem(itemID_or_itemLink_or_itemName) end
...
function IsCorruptedItem(itemID_or_name_or_itemlink) end
...
function IsEquippableItem(itemId_or_itemName_or_itemLink) end
...
function IsEquippedItem(itemID_or_itemName) end
...
function IsSpellClassOrSpec(spellName_or_spellIndex, bookType) end
...
function IsSpellInRange(index, bookType, target) end
...
function IsTalentSpell(spellName_or_slotIndex, bookType) end
...
function IsUsableSpell(spellName_or_spellID_or_spellIndex, bookType) end
...
function KBArticle_BeginLoading(id, searchType) end
...
function KBSetup_BeginLoading(articlesPerPage, currentPage) end
...
function LoadAddOn(index_or_name) end
...
function MoveBackwardStop(startTime) end
...
function MoveForwardStop(startTime) end
...
function MuteSoundFile(soundFile_or_fileDataID) end
...
function PickupItem(itemID_or_itemString_or_itemName_or_itemLink) end
...
function PickupMacro(macroName_or_macroID) end
...
function PickupSpellBookItem(spellName_or_index, bookType) end
...
function PlaceAction(actionSlot) end
...
function PlayMusic(musicfile_or_fileDataID) end
...
function PlaySoundFile(soundFile_or_soundFileID, channel) end
...
function PromoteToLeader(unitId_or_playerName) end
...
function RunMacro(macroID_or_macroName) end
...
function SetActionBarToggles(bottomLeftState, bottomRightState, sideRightState, sideRight2State, alwaysShow) end
...
function SetBindingMacro(key, macroName_or_macroId) end
...
function SetLootMethod(method, masterPlayer_or_threshold) end
...
function SetMacroSpell(index, spell, target) end
...
function SetTrainerServiceTypeFilter(type, status, exclusive) end
...
function SortGuildRoster(level) end
...
function StartDuel(playerName_or_unit, exactMatch) end
...
function StrafeRightStop(startTime) end
...
function TargetUnit(unit_or_name, exactMatch) end
...
function ToggleRun(theTime) end
...
function TurnLeftStop(stopTime) end
...
function TurnRightStop(startTime) end
...
---@return unknown base, number effectiveArmor, number armor, unknown posBuff, unknown negBuff
...
function UnitCanAssist(unitToAssist, unitToBeAssisted) end
...
function UnitHasIncomingResurrection(unitID_or_UnitName) end
...
function UnitHonor(unitID_or_unitName) end
...
function UnitHonorLevel(unitID_or_PlayerName) end
...
function UnitHonorMax(unitID_or_playerName) end
...
function UnitInVehicle(target) end
...
function UnitIsPVPFreeForAll(unitId) end
...
function UnitRangedDamage(player) end
...
function UnmuteSoundFile(soundFile_or_fileDataID) end
...
function UseInventoryItem(slotID) end
