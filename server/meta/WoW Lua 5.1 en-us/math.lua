...
---
---[View documents](http://www.lua.org/manual/5.1/manual.html#pdf-math.atan<5.2)
---
---@param y number
---@return number
...
---
---[View documents](http://www.lua.org/manual/5.1/manual.html#pdf-math.log<5.1)
---
---@param x     number
---@return number
...
---
---[View documents](http://www.lua.org/manual/5.1/manual.html#pdf-math.randomseed<5.3)
---
---@param x integer
