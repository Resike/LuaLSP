...
---
---[View documents](http://www.lua.org/manual/5.4/manual.html#pdf-math.atan>5.3)
---
---@param y  number
---@param x? number
---@return number
...
---
---[View documents](http://www.lua.org/manual/5.4/manual.html#pdf-math.log>5.2)
---
---@param x     number
---@param base? integer
---@return number
...
---
---[View documents](http://www.lua.org/manual/5.4/manual.html#pdf-math.randomseed>5.4)
---
---@param x? integer
---@param y? integer
