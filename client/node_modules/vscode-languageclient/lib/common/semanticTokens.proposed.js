...
const protocol_semanticTokens_proposed_1 = require("vscode-languageserver-protocol/lib/common/protocol.semanticTokens.proposed");
            ...
            provideDocumentSemanticTokensEdits: hasEditProvider
                ? (document, previousResultId, token) => {
                    ...
                    const provideDocumentSemanticTokensEdits = (document, previousResultId, token) => {
                        ...
                        return client.sendRequest(vscode_languageserver_protocol_1.Proposed.SemanticTokensDeltaRequest.type, params, token).then((result) => {
